            ...
            <section className="" >
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8 ">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold sm:text-5xl  text-[#143566] ">Frequently Asked Questions</h2>
                    </div>


                    <div className="space-y-4  rounded-lg shadow-xl p-6  ">

                        <details className="w-full border  border-cyan-700   rounded-lg">

                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">Can I use my health insurance?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">Why do you charge a membership fee and a fee for each doctor visit?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">What do you mean by "primary care"?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">What credentials do DoctorConsulta doctors have?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">Does DoctorConsulta give doctors notes?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">Are there any medications that DoctorConsulta  doctors cannot prescribe?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">Why do I need a primary care provider (PCP)?</summary>
                        ...
                        <details className="w-full border  border-cyan-700  rounded-lg">
                            <summary className="px-4 py-6 focus:outline-none  text-[#143566] lg:text-2xl md:text-xl text-base font-semibold">How is DoctorConsulta different from other telemedicine providers?</summary>
